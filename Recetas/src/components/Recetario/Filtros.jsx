...
const dietas = ["Vegetariana", "Vegana", "Sin Gluten", "Keto", "Sin Lactosa"];
const tiposPlato = ["Desayuno", "Plato Principal", "Postres", "Snacks/Picoteo", "Bebidas", "Sopas"];
const paises = ["Argentina", "Chile", "México", "España"];
